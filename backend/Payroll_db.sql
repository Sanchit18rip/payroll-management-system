...
INSERT INTO `attendance` VALUES (1,1,'Present','2026-06-03'),(2,2,'Present','2026-06-03'),(3,3,'Present','2026-06-03'),(4,8,'Present','2026-06-03'),(5,10,'Present','2026-06-03'),(6,1,'Present','2026-06-04'),(7,2,'Present','2026-06-04'),(8,3,'Present','2026-06-04');
...
INSERT INTO `employees` VALUES (1,'Rahul Sharma','IT',55000.00,5000.00,0.00),(2,'Priya Singh','HR',45000.00,0.00,0.00),(3,'Amit Verma','Finance',60000.00,0.00,0.00);
...
CREATE TABLE `leave_balance` (
  ...
  `available_leaves` int DEFAULT '2',
  PRIMARY KEY (`employee_id`),
  CONSTRAINT `leave_balance_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`)
...
INSERT INTO `leave_balance` VALUES (1,2),(2,2),(3,2);
/*!40000 ALTER TABLE `leave_balance` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `leave_month_tracker`
--

DROP TABLE IF EXISTS `leave_month_tracker`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `leave_month_tracker` (
  `id` int NOT NULL AUTO_INCREMENT,
  `last_processed_month` int DEFAULT NULL,
  `last_processed_year` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `leave_month_tracker`
--

LOCK TABLES `leave_month_tracker` WRITE;
/*!40000 ALTER TABLE `leave_month_tracker` DISABLE KEYS */;
INSERT INTO `leave_month_tracker` VALUES (1,6,2026);
/*!40000 ALTER TABLE `leave_month_tracker` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-09 16:44:09
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2026-06-02 10:44:16',NULL),('diagnostics.include_raw','OFF','2026-06-02 10:44:16',NULL),('ps_thread_trx_info.max_length','65535','2026-06-02 10:44:16',NULL),('statement_performance_analyzer.limit','100','2026-06-02 10:44:16',NULL),('statement_performance_analyzer.view',NULL,'2026-06-02 10:44:16',NULL),('statement_truncate_len','64','2026-06-02 10:44:16',NULL);
...
-- Dump completed on 2026-06-09 16:44:10
